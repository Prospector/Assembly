...
public class AssemblyFluidTags {
	...
	private static Tag.Identified<Fluid> of(AssemblyFluid fluid, Identifier id) {
	...
	private static Tag.Identified<Fluid> ofAssembly(AssemblyFluid fluid, String path) {
		return of(fluid, new Identifier(Assembly.MOD_ID, path));
	}

	private static Tag.Identified<Fluid> ofCommon(AssemblyFluid fluid, String path) {
		return of(fluid, new Identifier(AssemblyConstants.COMMON_NAMESPACE, path));
	}

	private static Tag.Identified<Fluid> get(AssemblyFluid fluid) {
