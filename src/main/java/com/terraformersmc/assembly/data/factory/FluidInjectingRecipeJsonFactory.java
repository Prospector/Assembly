...
import com.terraformersmc.assembly.recipe.serializer.FluidInjectingRecipeSerializer;
...
public class FluidInjectingRecipeJsonFactory {
	private static final String RECIPE_TYPE = "fluid_injecting";
	private final Ingredient input;
	private final FluidIngredient fluid;
	private final Item output;
	private final Advancement.Task builder = Advancement.Task.create();
	private String group;
	private final FluidInjectingRecipeSerializer serializer = AssemblyRecipeSerializers.FLUID_INJECTING;

	public FluidInjectingRecipeJsonFactory(Ingredient input, FluidIngredient fluid, Item output) {
		this.input = input;
		this.fluid = fluid;
		this.output = output;
	}

	public static FluidInjectingRecipeJsonFactory create(Ingredient itemInput, FluidIngredient fluidInput, ItemConvertible output) {
		return new FluidInjectingRecipeJsonFactory(itemInput, fluidInput, output.asItem());
	}

	public FluidInjectingRecipeJsonFactory criterion(String criterionName, CriterionConditions conditions) {
	...
	public FluidInjectingRecipeJsonFactory group(String group) {
		this.group = group;
		return this;
	}
	...
	public static class Provider implements RecipeJsonProvider {
		...
		private final FluidInjectingRecipeSerializer serializer;

		public Provider(Identifier recipeId, String group, Ingredient input, FluidIngredient fluid, Item output, Advancement.Task builder, Identifier advancementId, FluidInjectingRecipeSerializer serializer) {
