...
public class FluidInjectingRecipeFactory {
	...
	public FluidInjectingRecipeFactory(Ingredient input, FluidIngredient fluid, Item output) {
		this.input = input;
		this.fluid = fluid;
		this.output = output;
	}

	public static FluidInjectingRecipeFactory create(Ingredient itemInput, FluidIngredient fluidInput, ItemConvertible output) {
		return new FluidInjectingRecipeFactory(itemInput, fluidInput, output.asItem());
	}

	public FluidInjectingRecipeFactory criterion(String criterionName, CriterionConditions conditions) {
	...
	public FluidInjectingRecipeFactory group(String group) {
		this.group = group;
		return this;
	}
