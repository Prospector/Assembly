...
public class PressingRecipeFactory {
	...
	private PressingRecipeFactory(ItemConvertible output, Ingredient input, int presses, PressingRecipeSerializer serializer, String recipeType) {
	...
	public static PressingRecipeFactory create(Ingredient input, ItemConvertible output, int presses, PressingRecipeSerializer serializer, String recipeType) {
		return new PressingRecipeFactory(output, input, presses, serializer, recipeType);
	}

	public static PressingRecipeFactory createSteamPressing(Ingredient input, ItemConvertible output, int presses) {
		return create(input, output, presses, AssemblyRecipeSerializers.STEAM_PRESSING, "steam_pressing");
	}

	public static PressingRecipeFactory createSteamPressing(Ingredient input, ItemConvertible output) {
		return createSteamPressing(input, output, AssemblyRecipeSerializers.STEAM_PRESSING.getDefaultPresses());
	}

	public PressingRecipeFactory criterion(String criterionName, CriterionConditions conditions) {
