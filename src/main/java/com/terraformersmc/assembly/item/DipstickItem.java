	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		if (!context.getWorld().isClient()) {
			...
			if (blockEntity instanceof FluidHopperBlockEntity) {
				context.getPlayer().sendSystemMessage(new LiteralText(format + "Fluids: " + Arrays.toString(new Identifier[]{Registry.FLUID.getId(((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(0).getRawFluid()), Registry.FLUID.getId(((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(1).getRawFluid()), Registry.FLUID.getId(((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(2).getRawFluid()), Registry.FLUID.getId(((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(3).getRawFluid()), Registry.FLUID.getId(((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(4).getRawFluid())})));
				context.getPlayer().sendSystemMessage(new LiteralText(format + "Amounts: " + Arrays.toString(new String[]{((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(0).getAmount_F().toDisplayString(), ((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(1).getAmount_F().toDisplayString(), ((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(2).getAmount_F().toDisplayString(), ((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(3).getAmount_F().toDisplayString(), ((FluidHopperBlockEntity) blockEntity).getFluidTank().getInvFluid(4).getAmount_F().toDisplayString()})));
				context.getPlayer().sendSystemMessage(new LiteralText(format + "Capacites: " + Arrays.toString(new String[]{((FluidHopperBlockEntity) blockEntity).getFluidTank().getMaxAmount_F(0).toDisplayString(), ((FluidHopperBlockEntity) blockEntity).getFluidTank().getMaxAmount_F(1).toDisplayString(), ((FluidHopperBlockEntity) blockEntity).getFluidTank().getMaxAmount_F(2).toDisplayString(), ((FluidHopperBlockEntity) blockEntity).getFluidTank().getMaxAmount_F(3).toDisplayString(), ((FluidHopperBlockEntity) blockEntity).getFluidTank().getMaxAmount_F(4).toDisplayString()})));
				return ActionResult.SUCCESS;
			}
		}
