...
public class AssemblyBlocks implements ModInitializer {
	...
	static {
		RUBBER_LOG = AssemblyBlocks.register("rubber_log", new RubberLogBlock(MaterialColor.WOOD, FabricBlockBuilder.create(Material.WOOD).setStrength(2.0F, 2.0F).setSoundGroup(BlockSoundGroup.WOOD).build()), ItemGroup.DECORATIONS);
